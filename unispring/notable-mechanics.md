...
The V4 position is owned by a [Fountain]({{ site.baseurl }}/unispring/fountain) clone. Notable retains no authority over it after seating, and Fountain itself exposes no decrease-liquidity path — principal cannot be withdrawn by anyone, ever.
