...
Manifold mints fresh ERC-20 tokens and seats 100% of supply single-sided into a [Fountain]({{ site.baseurl }}/unispring/fountain) V4 position against a hub. Each launch produces a token with a permanent price floor and routable V4 liquidity from the deploy transaction onward.
...
See [DESIGN.md §14](https://github.com/uniteum/unispring/blob/main/DESIGN.md){:target="_blank"} for the catalog of options around a spent position.
