...
| Action | What it does |
|:-------|:-------------|
| [make(keyValues)](https://etherscan.io/address/{{< val "locale.address" >}}#writeContract#F{{< val "locale" "write" "make(keyValues)" "f" >}}) | Deploy a new lookup with chain-specific values |
| [made(keyValues)](https://etherscan.io/address/{{< val "locale.address" >}}#readContract#F{{< val "locale" "read" "made(keyValues)" "f" >}}) | Check if a lookup exists and preview its address |
