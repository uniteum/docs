...
Every Liquid token is both a standard ERC-20 and its own AMM. Deposits create instant tradeable depth through the [2x mint](/liquid/2x-mint) pattern. All Liquid tokens connect through a Hub token, enabling cross-pool swaps—100 tokens need 100 pools, not 5,000.
