...
- "1" tokens ({{< val "contracts.uniteum.name" >}}) in your wallet
...
See [Tokenomics](/uniteum/concepts/tokenomics/) for the math.
...
- [Price Control](/uniteum/guides/price-control/) — Use forging strategically
- [Arbitrage](/uniteum/concepts/arbitrage/) — Profit from price differences
