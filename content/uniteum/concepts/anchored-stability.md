...
- Contribute to aggregate value (Hypothesis 1 in [Economics of "1"](/uniteum/economics-of-one/))
...
On [Etherscan](https://etherscan.io/address/{{< val "contracts.uniteum.address" >}}#readContract):
...
- [Economics of "1"](/uniteum/economics-of-one/) — Broader hypotheses about "1" value
- [Arbitrage](/uniteum/concepts/arbitrage/) — How arbitrage maintains price consistency
- [Forge](/uniteum/concepts/forge/) — The operation that enables arbitrage
- [Units](/uniteum/concepts/units/) — Anchored vs floating unit mechanics
