...
**Contract:** [`{{< val "contracts.uniteum.address" >}}`](https://{{< escan >}}/address/{{< val "contracts.uniteum.address" >}}#code) ({{< val "contracts.uniteum.name" >}})
...
**Note:** The 1 billion figure sometimes cited as a ceiling is the **fixed supply of the separate genesis "1" token** ([`{{< val "contracts.genesis.address" >}}`](https://{{< escan >}}/address/{{< val "contracts.genesis.address" >}}#code)), not a value enforced by `ONE_MINTED`. Total current "1" supply is bounded indirectly by how much genesis "1" has been migrated in via {{< val "contracts.uniteum.name" >}}'s `migrate()`.
...
**Value:** [`{{< val "contracts.genesis.address" >}}`](https://{{< escan >}}/address/{{< val "contracts.genesis.address" >}}#code) — the genesis "1" token (currently `0x7D5B1349157335aEEB929080a51003B529758830`).
