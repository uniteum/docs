...
weight: 1
---
# Reflector — plain-English intro

A plain-English intro to what a Reflector issue is and what you can do with one.

For the technical reference, see [Reflector](/reflector/). For the peg mechanics, see [Reflector — peg mechanics](/reflector/mechanics/).
...
- [Reflector](/reflector/) — the factory and operations in full
