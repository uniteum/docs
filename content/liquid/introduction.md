...
This [2x minting](/liquid/2x-mint) creates instant liquidity. The pool's share provides tradeable depth; the exact split preserves the existing ratio between pooled and circulating tokens.
