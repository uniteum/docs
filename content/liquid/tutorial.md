...
The [Hub](https://{{< escan >}}/token/{{< val "liquids.hub.address" >}}) is the central contract — it wraps [Uniteum 1](https://{{< escan >}}/token/{{< val "solids" "1" "address" >}}) and acts as the factory for all spoke tokens.

We'll use [{{< val "liquids.spoke.name" >}} ({{< val "liquids.spoke.symbol" >}})](https://{{< escan >}}/token/{{< val "liquids.spoke.address" >}}#readContract#F{{< val "liquid" "read" "solid()" "f" >}}) as our example spoke, backed by [{{< val "backing.spoke.name" >}} ({{< val "backing.spoke.symbol" >}})](https://{{< escan >}}/token/{{< val "backing.spoke.address" >}}).
...
1. Go to [Uniteum 1 → approve](https://{{< escan >}}/token/{{< val "solids" "1" "address" >}}#writeContract#F{{< val "solid" "write" "approve(spender, value)" "f" >}})
...
1. Go to [Hub → heat(m, e)](https://{{< escan >}}/token/{{< val "liquids.hub.address" >}}#writeContract#F{{< val "liquid" "write" "heat(m, e)" "f" >}})
...
**Verify:** Call [`balanceOf`](https://{{< escan >}}/token/{{< val "liquids.hub.address" >}}#readContract#F{{< val "liquid" "read" "balanceOf(account)" "f" >}}) on the Hub with your wallet address.
...
1. Go to [Hub → made](https://{{< escan >}}/token/{{< val "liquids.hub.address" >}}#readContract#F{{< val "liquid" "read" "made(backing)" "f" >}})
...
1. Go to [Hub → make](https://{{< escan >}}/token/{{< val "liquids.hub.address" >}}#writeContract#F{{< val "liquid" "write" "make(backing)" "f" >}})
...
**Find the address:** Call [`made`](https://{{< escan >}}/token/{{< val "liquids.hub.address" >}}#readContract#F{{< val "liquid" "read" "made(backing)" "f" >}}) again with the same backing address. The `home` field is your spoke's contract.
...
1. Go to [{{< val "backing.spoke.name" >}} → approve](https://{{< escan >}}/token/{{< val "backing.spoke.address" >}}#writeContract#F{{< val "solid" "write" "approve(spender, value)" "f" >}})
2. Enter:
...
1. Go to [{{< val "liquids.spoke.symbol" >}} → heat(m, e)](https://{{< escan >}}/token/{{< val "liquids.spoke.address" >}}#writeContract#F{{< val "liquid" "write" "heat(m, e)" "f" >}})
...
**Verify:** Call [`pool`](https://{{< escan >}}/token/{{< val "liquids.spoke.address" >}}#readContract#F{{< val "liquid" "read" "pool()" "f" >}}) on {{< val "liquids.spoke.symbol" >}} — it returns `(P, E)` where P is spoke tokens in the pool and E is Hub tokens in the pool.
...
1. Go to [{{< val "liquids.spoke.symbol" >}} → sells](https://{{< escan >}}/token/{{< val "liquids.spoke.address" >}}#readContract#F{{< val "liquid" "read" "sells(s)" "f" >}})
...
1. Go to [{{< val "liquids.spoke.symbol" >}} → sell](https://{{< escan >}}/token/{{< val "liquids.spoke.address" >}}#writeContract#F{{< val "liquid" "write" "sell(s)" "f" >}})
...
1. Go to [{{< val "liquids.spoke.symbol" >}} → buys](https://{{< escan >}}/token/{{< val "liquids.spoke.address" >}}#readContract#F{{< val "liquid" "read" "buys(e)" "f" >}})
...
1. Go to [{{< val "liquids.spoke.symbol" >}} → buy](https://{{< escan >}}/token/{{< val "liquids.spoke.address" >}}#writeContract#F{{< val "liquid" "write" "buy(e)" "f" >}})
...
**Verify:** Call [`balanceOf`](https://{{< escan >}}/token/{{< val "liquids.spoke.address" >}}#readContract#F{{< val "liquid" "read" "balanceOf(account)" "f" >}}) on {{< val "liquids.spoke.symbol" >}} with your wallet address.
...
1. On spoke A, go to [`sellsFor`](https://{{< escan >}}/token/{{< val "liquids.spoke.address" >}}#readContract#F{{< val "liquid" "read" "sellsFor(that, s)" "f" >}})
2. Enter:
...
1. On spoke A, go to [`sellFor`](https://{{< escan >}}/token/{{< val "liquids.spoke.address" >}}#writeContract#F{{< val "liquid" "write" "sellFor(that, s)" "f" >}})
2. Enter:
   - `that`: spoke B's contract address
   - `spokes`: amount of spoke A to trade
3. Click **Write** and confirm
...
1. Go to [{{< val "liquids.spoke.symbol" >}} → cools](https://{{< escan >}}/token/{{< val "liquids.spoke.address" >}}#readContract#F{{< val "liquid" "read" "cools(u, e)" "f" >}})
...
1. Go to [{{< val "liquids.spoke.symbol" >}} → cool](https://{{< escan >}}/token/{{< val "liquids.spoke.address" >}}#writeContract#F{{< val "liquid" "write" "cool(u, e)" "f" >}})
2. Enter `u` — the amount of {{< val "liquids.spoke.symbol" >}} tokens to burn
3. Enter `e = 0` — pass `0` for a liquid-only exit (no hub withdrawn from the lake)
4. Click **Write** and confirm
...
To unwrap Hub back to "Uniteum 1", call [`cool`](https://{{< escan >}}/token/{{< val "liquids.hub.address" >}}#writeContract#F{{< val "liquid" "write" "cool(u, e)" "f" >}}) on the Hub with `e = 0` — this is a simple 1:1 unwrap (the Hub ignores `e`).
...
### Hub ([`{{< val "liquids.hub.address" >}}`](https://{{< escan >}}/token/{{< val "liquids.hub.address" >}}))
...
### Spoke (links use [{{< val "liquids.spoke.symbol" >}}](https://{{< escan >}}/token/{{< val "liquids.spoke.address" >}}) — any spoke works the same way)
