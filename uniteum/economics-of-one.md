...
{: .note }
> For "1" supply mechanics and invariant mathematics, see [Tokenomics](/uniteum/concepts/tokenomics/). This page focuses on economic value hypotheses.
...
> **Notation:** We use [0xWETH](/uniteum/reference/anchored-units/weth/), [0xUSDC](/uniteum/reference/anchored-units/usdc/), etc. as readable shorthands. These actually represent full address-based symbols. See [Anchored Units](/uniteum/reference/anchored-units/) for details.
...
> **Note:** For a detailed technical exploration of this mechanism, see [Anchored Unit Stability](/uniteum/concepts/anchored-stability/).
...
- [Tokenomics](/uniteum/concepts/tokenomics/) — The invariant and supply mechanics
- [Arbitrage](/uniteum/concepts/arbitrage/) — How price consistency emerges
- [Use Cases](/uniteum/use-cases/) — What this enables for participants
- [Forge](/uniteum/concepts/forge/) — The operation that moves "1" between contracts

## Observing in Practice

**Check "1" contract:**
- {% include etherscan.html address=site.data.contracts.uniteum.address section="readContract" text="Mainnet" %}
