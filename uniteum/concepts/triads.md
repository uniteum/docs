...
{: .note }
> For forge mechanics, see [Forge](/uniteum/concepts/forge/).  
> For invariant mathematics, see [Tokenomics](/uniteum/concepts/tokenomics/).
...
In each case, the compound Unit is a **Unit identity** created separately (see [Unit Creation](/uniteum/concepts/unit-creation)) and participates economically through the triad.
