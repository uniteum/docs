...
See [Use Cases]({{ site.baseurl }}/solid/use-cases) for full narratives and concrete examples.
...
For a deeper look at the design, see the [Protocol]({{ site.baseurl }}/solid/protocol) page.
...
- [Protocol]({{ site.baseurl }}/solid/protocol)
- [Use Cases]({{ site.baseurl }}/solid/use-cases)
