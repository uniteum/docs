...
> **Notation:** For readability, we use `$WETH`, `$USDC`, etc. in examples. Remember that anchored units actually use full contract addresses: `$0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2` for WETH. See [Anchored Units](#anchored-units) below.
...
- `$USDC` — backed 1:1 by real USDC held in the contract
