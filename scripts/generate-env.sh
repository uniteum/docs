...
CURRENT_HELPER_VERSION=$(yq eval '.current.helper // "v0_5"' "$CONTRACTS_FILE")
...
HELPER_CURRENT=$(yq eval ".helper.${CURRENT_HELPER_VERSION}.mainnet" "$CONTRACTS_FILE")
...
# Current Helper version: $CURRENT_HELPER_VERSION
