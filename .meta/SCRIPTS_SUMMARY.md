...
This updates `units.yml` with correct addresses and canonical forms.
...
### `_data/units.yml` (Generated)

Output file with computed addresses (flat key-value map, key is symbol):
